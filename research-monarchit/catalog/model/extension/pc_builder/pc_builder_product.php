...
class ModelExtensionPcBuilderPcBuilderProduct extends Model {
	...
	public function getProducts($data = array()) {
		...
		if (!empty($data['filter_category_ids'])) {
			...
			//if (!empty($data['selected_products'])) {
			//	$data['filter_category_ids'] = array_intersect($data['filter_category_ids'], array_unique($incompatible_categories));
			//}
			//if (!empty($data['selected_products'])) {
			//	$filter_category_ids = $data['filter_category_ids'];
				
			//	$data['filter_category_ids'] = array();

			//	foreach ($filter_category_ids as $filter_category_id) {
			//		if (in_array($filter_category_id, $incompatible_categories)) {
