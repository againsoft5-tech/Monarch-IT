...
class ControllerExtensionPcBuilderPcBuilderProduct extends Controller {
		...
		if ($product_info) {
            ...
            if (defined('JOURNAL3_ACTIVE')) {
                ...
                if ($this->journal3->document->isPopup()) {
                    $data['view_more_url'] = $this->url->link('extension/pc_builder/pc_builder_product', 'product_id=' . (int)$this->request->get['product_id']);
                }
            }
			...
			$data['share'] = $this->url->link('extension/pc_builder/pc_builder_product', 'product_id=' . (int)$this->request->get['product_id']);
			...
			foreach ($results as $result) {
				...
				$data['products'][] = array(
					...
					'rating'      => $rating,
					'href'        => $this->url->link('extension/pc_builder/pc_builder_product', 'product_id=' . $result['product_id'])
				);
			}
            ...
            $data['back'] = $this->url->link('extension/pc_builder/pc_builder_search', '&pc_builder_component_id=' . $this->request->get['pc_builder_component_id']);
	...
	public function review() {
		...
		$pagination->limit = 5;
		$pagination->url = $this->url->link('extension/pc_builder/pc_builder_product/review', 'product_id=' . $this->request->get['product_id'] . '&page={page}');
